 ...
 * Purpose:		This program's main function is to encipher some messages using a simple yet efficient algorithm based on the ceasar encryption
...
public class YA_Regular_Salad {
    ...
    public static void main(String[] args) {
        ...
        { // Start of encipher
            ...
            ShiftValues = YA_Project_Methods.shiftGenerator(KeyWord);
            enText = YA_Project_Methods.encipherText(plainText, ShiftValues);
        ...
        else // We don't have to specify it's value 2 since there are only two options.
        {
        	...
        	KeyWord = YA_Project_Methods.keyword(input);
        	ShiftValues = YA_Project_Methods.shiftGenerator(KeyWord);
        	plainText = YA_Project_Methods.decipherText(enText, ShiftValues);
        ...
        // Close the Scanner object on both classes.
        input.close();
    }
    // end main
}
